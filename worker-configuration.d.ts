/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: e6a7e304f71aeb273a745830628afa87)
// Runtime types generated with workerd@1.20260801.1 2026-08-08 nodejs_compat
interface __BaseEnv_Env {
	ASSETS: Fetcher;
	ENVIRONMENT: "staging" | "production" | "development";
	BUILD_ID: "staging" | "production" | "local";
	SUPABASE_URL: string;
	SUPABASE_PROJECT_REF: string;
	SUPABASE_PUBLISHABLE_KEY: string;
	SUPABASE_SERVICE_ROLE_KEY: string;
	KIT_CODE_PEPPER: string;
	COMPILER_SERVICE_URL: string;
	COMPILER_SERVICE_ORIGIN: string;
	COMPILER_SERVICE_HOST: string;
	COMPILER_SERVICE_TOKEN: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "BUILD_ID" | "SUPABASE_URL" | "SUPABASE_PROJECT_REF" | "SUPABASE_PUBLISHABLE_KEY" | "SUPABASE_SERVICE_ROLE_KEY" | "KIT_CODE_PEPPER" | "COMPILER_SERVICE_URL" | "COMPILER_SERVICE_ORIGIN" | "COMPILER_SERVICE_HOST" | "COMPILER_SERVICE_TOKEN">> {}
}

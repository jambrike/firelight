...
export function CampfireScene() {
  ...
  useLayoutEffect(() => {
    ...
    if (canvas?.ownerDocument.defaultView?.navigator.userAgent.includes("jsdom")) return;
    const context = canvas?.getContext("2d");
    if (!context) return;

    context.imageSmoothingEnabled = false;
    context.setTransform(SCENE_SCALE, 0, 0, SCENE_SCALE, 0, 0);
  ...
  return (
    <div className="home-camp-scene" aria-hidden="true">
      <canvas
        ref={canvasRef}
        className="home-camp-scene__canvas"
